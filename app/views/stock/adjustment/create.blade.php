...
@section('formAction') {{ route('adjustment.store') }} @stop
@section('formBody')
    ...
    <div class='row'>
        <div class="form-group col-sm-6">
            ...
            <input type='text' class="form-control" id="adjust_man_id" placeholder="调整人" name='adjust_man_id' value="{{ old('adjust_man_id') }}">
        </div>
        <div class="form-group col-sm-6">
