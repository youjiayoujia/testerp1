...
<div class="bjui-searchBar">
    <label>型号：</label><input type="text" class="form-control" size="10" name="size" value="{{ old('size') }}">&nbsp;
    <label>颜色：</label><input type="text" class="form-control" size="10" name="color" value="{{ old('color') }}">&nbsp;
    <button type="button" class="showMoreSearch" data-toggle="moresearch" data-name="more"><i class="fa fa-angle-double-down"></i></button>
    <button type="submit" class="btn-default" data-icon="search">查询</button>&nbsp;
    <a class="btn btn-orange" href="javascript:;" onclick="$(this).navtab('reload', true);" data-icon="undo">清空查询</a>
    ...
    <table data-toggle="tablefixed" data-width="100%" data-nowrap="true">
        <thead>
            <tr>
                ...
                <th data-order-field="brand">品牌</th>
                <th data-order-field="size">型号</th>
                <th data-order-field="color">颜色</th>
                <th data-order-field="created_at">登记时间</th>
