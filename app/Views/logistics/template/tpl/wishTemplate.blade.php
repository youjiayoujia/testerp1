    ...
    <table border="0" style="width:382px;height:155px;" cellspacing="0" cellpadding="0">
        <tr height="45">
            <td colspan="3" style="border-top:none;">
                ...
                <p style="width:270px;height:45px;float:left;text-align:center;">
                    <img src="'.site_url('default/third_party').'/chanage_code/barcode/html/image.php?code=code128&o=2&t=15&r=2&text={{ $model->tracking_no }}&f1=-1&f2=8&a1=&a2=B&a3="/>
                    {{ $model->tracking_no }}
                </p>
            </td>
        </tr>
        <tr height="15">
            <td colspan="3" style="font-size:10px;font-weight:bold;">
                退件单位:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ $model->logistics ? ($model->logistics->emailTemplate ? ($model->logistics->emailTemplate->address) : '') : '' }}
            </td>
        </tr>
