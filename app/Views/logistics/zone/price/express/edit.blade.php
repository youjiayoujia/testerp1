...
@section('formBody')
    ...
    <div class="form-group col-lg-4">
        ...
        <small class="text-danger glyphicon glyphicon-asterisk"></small>
        <input class="form-control" id="fixed_weight" placeholder="首重(kg)" name='fixed_weight' value="{{ old('fixed_weight') ? old('fixed_weight') : $zonePriceExpress->fixed_weight }}">
    </div>
    <div class="form-group col-lg-4">
        <label for="fixed_price" class="control-label">首重价格(/kg)</label>
        <small class="text-danger glyphicon glyphicon-asterisk"></small>
        <input class="form-control" id="fixed_price" placeholder="首重价格(/kg)" name='fixed_price' value="{{ old('fixed_price') ? old('fixed_price') : $zonePriceExpress->fixed_price }}">
    </div>
    <div class="form-group col-lg-4">
        <label for="continued_weight" class="control-label">续重(kg)</label>
        <small class="text-danger glyphicon glyphicon-asterisk"></small>
        <input class="form-control" id="continued_weight" placeholder="续重(kg)" name='continued_weight' value="{{ old('continued_weight') ? old('continued_weight') : $zonePriceExpress->continued_weight }}">
    </div>
    <div class="form-group col-lg-4">
        <label for="continued_price" class="control-label">续重价格(/kg)</label>
        <small class="text-danger glyphicon glyphicon-asterisk"></small>
        <input class="form-control" id="continued_price" placeholder="续重价格(/kg)" name='continued_price' value="{{ old('continued_price') ? old('continued_price') : $zonePriceExpress->continued_price }}">
    </div>
    <div class="form-group col-lg-4">
    ...
    <div class="form-group col-lg-4">
        ...
        <small class="text-danger glyphicon glyphicon-asterisk"></small>
        <input class="form-control" id="discount" placeholder="最后折扣(八折录入0.8)" name='discount' value="{{ old('discount') ? old('discount') : $zonePriceExpress->discount }}">
    </div>
@stop