...
Class WishAdapter implements AdapterInterface
{
    ...
    public function parseOrder($order, $transaction_number)
    {
        ...
        foreach ($order as $key => $orderSingle) {
            ...
            if(($this->client_id=='57e9ceaec9727a1331cd81dd')&&(date('Y-m-d H:i:s',strtotime($orderInfo['payment_date'])-8*3600)<'2016-12-08 15:00:00'||date('Y-m-d H:i:s',strtotime($orderInfo['payment_date'])-8*3600)>'2016-12-14 13:00:00')){
                continue;
            }
