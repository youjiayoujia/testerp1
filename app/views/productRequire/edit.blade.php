...
@section('formBody')
    ...
    <div class="form-group">
     ...
     <div class="form-group">
        ...
        <input type='text' class="form-control" id="address" placeholder="产品货源地" name='address' value="{{ old('address') ? old('address') : $productRequire->address }}">
    </div>
     <div class="form-group">
    ...
    <div class='form-group'>
        ...
        <input type='date' name='expdate' id='expdate' value="{{ old('expdate') ? old('expdate') : $productRequire->expdate }}">
    </div>
