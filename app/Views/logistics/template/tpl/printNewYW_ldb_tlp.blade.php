    ...
    <body>
        <style>
            *{padding:0;margin:0 auto;}
            .main1{width:97mm;height:97mm;margin:auto;font-size:10px;line-height: 12px;border:1px solid black;margin-top:1mm;}
            .header1{height:80px;}
            .fk{display:inline-block;width:8px;height:8px;border:1px solid #000;padding-top:0px;line-height: 8px;}
            table tr td{border-bottom:1px solid black;border-right:1px solid black;text-align:center;}
