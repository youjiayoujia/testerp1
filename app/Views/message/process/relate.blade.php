    ...
    <div class="panel-body">
        <form action="{{ route('message.process', ['id'=>$message->id]) }}" method="POST">
            ...
            <div class="row form-group">
                <div class="col-lg-8">
                    <input type="email" class="form-control" name="email" placeholder="填写Email"/>
                </div>
                <div class="col-lg-4">
...
<div class="panel panel-danger">
    ...
    <div class="panel-body">
        <form action="{{ route('message.setRelatedOrders', ['id'=>$message->id]) }}" method="POST">
            {!! csrf_field() !!}
            @if(isset($relatedOrders['history']) and count($relatedOrders['history']) > 0)
                <div class="panel panel-default">
                    <div class="panel-heading">历史关联</div>
                    <div class="panel-body">
                        @foreach($relatedOrders['history'] as $relatedOrder)
                            <div class="row form-group">
                                <div class="col-lg-1">
                                    <input type="checkbox" name="relatedOrdernums[]" value="{{ $relatedOrder->order->ordernum }}" />
                                </div>
                                <div class="col-lg-4">
                                    <strong>订单号</strong>: {{ $relatedOrder->order->ordernum }}
                                </div>
                                <div class="col-lg-6">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        @foreach($relatedOrders['email'] as $relatedOrder)
                            <div class="row form-group">
                                <div class="col-lg-1">
                                    <input type="checkbox" name="relatedOrdernums[]" value="{{ $relatedOrder->ordernum }}" />
                                </div>
                                <div class="col-lg-4">
