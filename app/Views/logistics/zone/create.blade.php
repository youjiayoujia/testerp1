                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <div class='form-group'>
                                ...
                                <div class='col-lg-4'>
                                    <input type='checkbox' class='country' name='countrys[]' value="{{ $country->id }}" {{ $model ? ($model->weatherAvailable($country->id) ? 'disabled' : '') : '' }}><font size='3px'>{{ $country->cn_name }}</font>
                                </div>
                                @endforeach
                            </div>
                            @endforeach
    ...
    <div class="panel panel-default first">
        ...
        <div class="panel-body">
            ...
            <div class='row'>
                ...
                <div class="form-group col-lg-3">
                    <label for="discount" class="control-label">是否通折</label> <small class="text-danger glyphicon glyphicon-asterisk"></small>
