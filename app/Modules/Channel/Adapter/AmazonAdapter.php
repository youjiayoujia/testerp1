...
Class AmazonAdapter implements AdapterInterface
{
    ...
    public function testXML($tracking_info)
    {
        ...
        <Message>
            ...
            <OrderFulfillment>
                <AmazonOrderID>116-6770178-1261059</AmazonOrderID>
                <FulfillmentDate>2016-03-10T07:59:59+00:00</FulfillmentDate>
                <FulfillmentData>
                    <CarrierName>China Post</CarrierName>
                    <ShippingMethod>e-packet</ShippingMethod>
                    <ShipperTrackingNumber>LS598110942CN</ShipperTrackingNumber>
                </FulfillmentData>
                <Item>
                    <AmazonOrderItemCode>06285235305074</AmazonOrderItemCode>
                    <Quantity>1</Quantity>
                </Item>
            </OrderFulfillment>
        </Message>
    ...
    <AmazonEnvelope xsi:noNamespaceSchemaLocation='amzn-envelope.xsd' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'>
        ...
        foreach($arr as $key => $value)
        {
            ...
            $str .= $this->getSingleXML(($key+1),$object, $value[1], $amazonOrderId);
        }
    ...
    public function getSingleXML($i, $object, $tracking_num, $amazonOrderId)
    {
        $str = "<Message>
        ...
        foreach($object as $key => $value) {
            $str .= "<Item>
                    <AmazonOrderItemCode>".$value['item']."</AmazonOrderItemCode>
