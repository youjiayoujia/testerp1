    ...
    {{--<div class="panel panel-default">--}}
        ...
        {{--<div class="panel-body">--}}
            ...
            {{--<div class="form-group col-lg-2">--}}
                ...
                {{--<input class="form-control" id="aliexpress_loginId" placeholder="买家ID" name='aliexpress_loginId' value="{{ old('aliexpress_loginId') ? old('aliexpress_loginId') : $model->aliexpress_loginId }}">--}}
            {{--</div>--}}
            {{--<div class="form-group col-lg-2">--}}
