...
@section('formBody')
    ...
    <div class="form-group col-lg-4">
        ...
        <small class="text-danger glyphicon glyphicon-asterisk"></small>
        <input class="form-control" id="price" placeholder="价格" name='price' value="{{ old('price') ? old('price') : $zonePricePacket->price }}">
    </div>
    <div class="form-group col-lg-4">
    ...
    <div class="form-group col-lg-4">
        ...
        <small class="text-danger glyphicon glyphicon-asterisk"></small>
        <input class="form-control" id="discount" placeholder="最后折扣" name='discount' value="{{ old('discount') ? old('discount') : $zonePricePacket->discount }}">
    </div>
@stop