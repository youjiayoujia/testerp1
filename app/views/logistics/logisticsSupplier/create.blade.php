@extends('common.form')
@section('title') 添加物流商 @stop
@section('breadcrumbs')
    <ol class="breadcrumb">
        <li><a href="/">主页</a></li>
        <li><a href="{{ route('logisticsSupplier.index') }}">物流商</a></li>
        <li class="active"><strong>添加物流商</strong></li>
    </ol>
@stop

@section('formTitle') 添加物流商 @stop
...
@section('formBody')
    ...
    <div class="form-group">
        ...
        <div class="radio">
            <label>
                <input type="radio" name="is_api" value="N" checked {{old('is_api') ? (old('is_api') == 'N' ? 'checked' : '') : 'checked'}}>没有
            </label>
        </div>
    </div>
    <div class="form-group">
