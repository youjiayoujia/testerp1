...
<div id="main_frame_box">
    ...
    <table style="width:381px;height:155px;border: 1px;" cellspacing="0" cellpadding="0">
        ...
        <tr style="height:15px;">
            ...
            <td width="60%" style="font-size:11px;text-align:center;">2016-06-13 11:14</td>
        </tr>
    </table>
    <div style="width:382px;height:40px;margin:0 auto;font-size:10px;white-space:normal;overflow:hidden;">CA3209B*1
