    ...
    <div class="form-group col-md-3">
        ...
        <select  class="form-control" name="carriage_limit">
            ...
            @foreach(config('product.carriage_limit') as $carriage_key=>$carriage_limit)
                <option value="{{ $carriage_limit }}" {{ $product->carriage_limit == $carriage_limit ? 'selected' : '' }} >{{$carriage_limit}}</option>
            @endforeach
        </select>
    </div>
    <div class="form-group col-md-3">
        ...
        <select  class="form-control" name="carriage_limit_1">
            <option value=""></option>
            @foreach(config('product.carriage_limit') as $carriage_key=>$carriage_limit)
                <option value="{{ $carriage_limit }}" {{ $product->carriage_limit_1 == $carriage_limit ? 'selected' : '' }} >{{$carriage_limit}}</option>
            @endforeach
        </select>
    ...
    <div class="form-group col-md-3">
        ...
        <select  class="form-control" name="package_limit">
            ...
            @foreach(config('product.package_limit') as $package_key=>$package_limit)
                <option value="{{ $package_limit }}" {{ $product->package_limit == $package_limit ? 'selected' : '' }} >{{$package_limit}}</option>
            @endforeach
        </select>
    </div>
    <div class="form-group col-md-3">
