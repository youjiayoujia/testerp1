...
<script type="text/javascript">
            ...
            JSPATH: 'BJUI/', //[可选]框架路径
                    ...
                    pageInfo: {total: 'total', pageCurrent: 'page', pageSize: 'pageSize', orderField: 'orderField', orderDirection: 'orderDirection'}, //[可选]分页参数
...
<link type="text/css" rel="stylesheet" href="{{ asset('/js/syntaxhighlighter-2.1.382/styles/shThemeEclipse.css') }}"/>
