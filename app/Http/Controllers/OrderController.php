...
//        }
        ...
        $response = [
            ...
            'data' => $this->autoList($this->model, $order, ['*'], null, 'restrict',
                [
                    'packages' => ['id', 'weight', 'cost', 'tracking_link', 'status', 'is_mark'],
                    'channel' => ['name', 'driver'],
                    'channelAccount' => ['alias'],
                    'userOperator' => ['name'],
                    'country' => ['name', 'cn_name'],
                    'remarks' => ['remark', 'created_at'],
                    'remarks.user' => ['name'],
                    'unpaidOrder' => ['note'],
                    'refunds' => ['id', 'refund_amount', 'created_at'],
                    'items' => ['id', 'orders_item_number', 'quantity', 'sku', 'price', 'ebay_unpaid_status'],
                    'items.item' => ['product_id', 'status', 'c_name'],
                    'items.item.warehouse' => ['name'],
                    'packages.logistics' => ['name'],
                    'packages.warehouse'=> ['name'],
                ]
            ),
