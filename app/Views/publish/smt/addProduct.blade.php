...
<div class="panel panel-default">
    ...
    <div class="panel-body"> 
        ...
        <div class="row">
            ...
            <div class="col-sm-3">	         
                <select name="productUnit" id="productUnit" class="form-control" datatype="n" nullmsg="单位不能为空" errormsg="单位的值类型错误">
                    ...
                    @foreach($productUnit as $id => $unit)
                    <option value="{{$unit->id}}" <?php echo $unitId == $id ? 'selected="selected"' : ''; ?>>{{$unit->name}}( {{$unit->name_en}}) </option>
                    @endforeach
                   -->
                </select>			    
			</div>
        ...
        <div class="row">
            ...
            <div class="col-sm-2">
                <label >(单位：厘米，每<b class="unit_cn"><?php echo $unitId ? $unit[$unitId]['name'] : '袋'; ?></b>&nbsp;<b id="volume">0</b>&nbsp;cm3)</label>                                             
            </div>
       ...
       <div class="procnt" id="price_attributes">
        <div class="row">
                ...
                ?>
                  <div class="row">
                    <div class="form-group <?php echo $sku_property ? 'hide' : ''; ?>">
                        <label for="productPrice" class="col-sm-2" ><span class="red">*</span>零售价：</label>
                ...
                <div class="row">
                    <div class="form-group wholesale_set <?php echo $smtApi->filterData('bulkOrder', $draft_detail) && $smtApi->filterData('bulkDiscount', $draft_detail) ? '' : 'hide'; ?>">
                        ...
                        <div class="input-group col-sm-3">
                            ...
                            <div class="input-group-addon unit_cn"><?php echo $unitId ? $unit[$unitId]['name'] : '袋'; ?></div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="row">
                        <div class="form-group clearfix ">
                            ...
                            <div class="col-sm-8">                        
        					    <textarea id="detail" name="detail" placeholder="产品详情描述" > <?php echo $draft_detail ? $draft_detail['detail'] : '' ?></textarea>                                                             
                            </div>                     
                        </div>
                 </div>
            </div>
...
<script type="text/javascript">
    ...
    KindEditor.ready(function (K) {
        var editor = K.create("[name=detail]", {
            //'uploadJson': "{{route('upload',['token_id'=> $token_id])}}",
            "width": "100%",
            "height": "400px",
    ...
    K('.from_local').click(function () {
        ...
        editors.loadPlugin('multiimage', function () { 
        	console.log(editors.plugin.multiImageDialog);    	
